...
@Component
class CustomOAuthUserService : DefaultOAuth2UserService() {
    ...
    override fun loadUser(userRequest: OAuth2UserRequest): OAuth2User {
        ...
        val valueList = response.body!!["response"] as ArrayList<*>?
        ...
        userAttributes["name"] = userAttributes["first_name"].toString() + " " + userAttributes["last_name"].toString()
