...
import com.example.gamehandlerservice.service.rooms.management.RoomManager
...
class UserHandshakeInterceptor(
    ...
    override fun beforeHandshake(
        ...
        try {
            ...
            val roomId = requireNotNull(UriComponentsBuilder
    ...
    private fun extractJwtTokenFromRequest(request: ServerHttpRequest): String? {
        val header = request.headers["Authorization"]?.firstOrNull()
